...
function setup() {
  ...
  landing=createSprite(500,350,10,10);
  landing.addImage("landing",landingImg);
  landing.scale=0.3;
  landing.debug=true;
  landing.setCollider("rectangle",0,200,500,10)
  rectMode(CENTER);
  textSize(15);
}
...
function draw() 
{
  ...
  lander.position.x +=vx;
   if(lander.isTouching(landing)){
     lander.velocityY=0;
     lander.velocityX=0;
     lander.collide(landing);
   }
